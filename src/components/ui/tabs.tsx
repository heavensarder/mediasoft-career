...
>(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cn(
            "inline-flex h-10 items-center justify-center rounded-md bg-muted p-1 text-muted-foreground clay-input",
            className
        )}
        {...props}
    />
    ...
    return (
        <button
            ...
            className={cn(
                ...
                isActive && "bg-background text-foreground shadow-sm clay-button text-primary",
                className
            )}
            onClick={(e) => {
